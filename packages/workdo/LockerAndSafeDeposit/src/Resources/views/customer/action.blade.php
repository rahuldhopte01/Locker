@permission('locker_customer edit')
<div class="action-btn  me-2">
    <a class="mx-3 btn bg-info btn-sm  align-items-center" data-url="{{ route('locker-customer.edit', $customer->id) }}"
...
@endpermission
@permission('locker_customer delete')
<div class="action-btn">
    {{ Form::open(['route' => ['locker-customer.destroy', $customer->id], 'class' => 'm-0']) }}
    @method('DELETE')
