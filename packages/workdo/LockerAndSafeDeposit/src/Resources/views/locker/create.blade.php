{{ Form::open(['route' => 'locker.store', 'method' => 'post', 'class'=>'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                {{ Form::label('locker_number', __('Locker Number'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::text('locker_number', $suggestedNumber ?? '', ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('e.g. LOC-00001'), 'maxlength' => '20']) }}
                <small class="text-muted">{{ __('Unique identifier, max 20 characters') }}</small>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form-group">
